...
class Discount(models.Model):
    ...
    type = models.CharField(max_length=10, choices=DISCOUNT_TYPE_CHOICES, verbose_name="Discount Type")
    amount = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(0)], verbose_name="Discount Amount")
    ...
    max_usage = models.PositiveIntegerField(default=1, verbose_name="Maximum Overall Usage")
    usage_count = models.PositiveIntegerField(default=0, editable=False, verbose_name="Usage Count")
    usage_per_user = models.PositiveIntegerField(default=1, verbose_name="Maximum Usage Per User")
...
class DiscountRule(models.Model):
    discount = models.ForeignKey(Discount, related_name='rules', on_delete=models.CASCADE, verbose_name="Discount")
    products = models.ManyToManyField(Product, blank=True, verbose_name="Applicable Products")
    categories = models.ManyToManyField(Category, blank=True, verbose_name="Applicable Categories")
    tags = models.ManyToManyField(Tag, blank=True, verbose_name="Applicable Tags")
    variants = models.ManyToManyField(ProductVariant, blank=True, verbose_name="Applicable Variants")
...
class UserDiscountUsage(models.Model):
    ...
    discount = models.ForeignKey(Discount, on_delete=models.CASCADE, related_name='user_usages')
